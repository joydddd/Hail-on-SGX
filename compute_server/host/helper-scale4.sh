...
do
    echo "Lin 5000"
    ./gwashost configs/compute_server_config1250linobv-4.json >> scaling-5k-64-4.txt
done
...
do
     echo "Lin 10000"
    ./gwashost configs/compute_server_config2500linobv-4.json >> scaling-10k-64-4.txt
done
...
do
    echo "Lin 20000"
    ./gwashost configs/compute_server_config5000linobv-4.json >> scaling-20k-64-4.txt
done
