...
#define OUTPUT_FILE "test_linear.out"

#include "enclave.h"
#include "enc_gwas.h"
const vector<vector<string>> covFiles = {
    {"../samples/1kg-linear-regression/isfemale_1.tsv",
     "../samples/1kg-logistic-regression/isfemale_2.tsv"}};
...
void getcov(const char host[MAX_HOST_LENGTH],
            const char cov_name[MAX_HOST_LENGTH],
