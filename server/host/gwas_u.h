 ...
 */
#ifndef EDGER8R_GWAS_U_H
#define EDGER8R_GWAS_U_H
...
/**** ECALL prototypes. ****/
oe_result_t log_regression(oe_enclave_t* enclave);

oe_result_t linear_regression_beta(oe_enclave_t* enclave);

oe_result_t linear_regression_t_stat(oe_enclave_t* enclave);
...
void gety(
    const char host[MAX_CLIENTNAME_LENGTH],
...
bool getbatch(
    const char hostname[MAX_CLIENTNAME_LENGTH],
    enum Row_T type,
