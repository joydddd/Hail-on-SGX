...
enum
{
    gwas_fcn_id_log_regression = 0,
    gwas_fcn_id_linear_regression_beta = 1,
    gwas_fcn_id_linear_regression_t_stat = 2,
    gwas_fcn_id_oe_get_sgx_report_ecall = 3,
    gwas_fcn_id_oe_get_report_v2_ecall = 4,
    gwas_fcn_id_oe_verify_local_report_ecall = 5,
    gwas_fcn_id_oe_sgx_init_context_switchless_ecall = 6,
    gwas_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 7,
    gwas_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};

/**** Trusted function names. ****/
static const oe_ecall_info_t _gwas_ecall_info_table[] = 
{
    { "log_regression" },
    { "linear_regression_beta" },
    { "linear_regression_t_stat" },
...
typedef struct _log_regression_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} log_regression_args_t;

typedef struct _linear_regression_beta_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} linear_regression_beta_args_t;

typedef struct _linear_regression_t_stat_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} linear_regression_t_stat_args_t;
...
oe_result_t gwas_log_regression(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    log_regression_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(log_regression_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(log_regression_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (log_regression_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _gwas_ecall_info_table[gwas_fcn_id_log_regression].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (log_regression_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(gwas_log_regression, log_regression);

oe_result_t gwas_linear_regression_beta(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    linear_regression_beta_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(linear_regression_beta_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(linear_regression_beta_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (linear_regression_beta_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _gwas_ecall_info_table[gwas_fcn_id_linear_regression_beta].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (linear_regression_beta_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(gwas_linear_regression_beta, linear_regression_beta);

oe_result_t gwas_linear_regression_t_stat(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    linear_regression_t_stat_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(linear_regression_t_stat_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(linear_regression_t_stat_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (linear_regression_t_stat_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _gwas_ecall_info_table[gwas_fcn_id_linear_regression_t_stat].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (linear_regression_t_stat_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(gwas_linear_regression_t_stat, linear_regression_t_stat);

oe_result_t gwas_oe_get_sgx_report_ecall(
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _gwas_ecall_info_table[gwas_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(gwas_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t gwas_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _gwas_ecall_info_table[gwas_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(gwas_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t gwas_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _gwas_ecall_info_table[gwas_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(gwas_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t gwas_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _gwas_ecall_info_table[gwas_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(gwas_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t gwas_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _gwas_ecall_info_table[gwas_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(gwas_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);

/**** Untrusted function IDs. ****/
enum
{
    gwas_fcn_id_getclientlist = 0,
    gwas_fcn_id_getcovlist = 1,
    gwas_fcn_id_gety = 2,
    gwas_fcn_id_getcov = 3,
    gwas_fcn_id_getbatch = 4,
    gwas_fcn_id_writebatch = 5,
    gwas_fcn_id_oe_syscall_epoll_create1_ocall = 6,
    gwas_fcn_id_oe_syscall_epoll_wait_ocall = 7,
    gwas_fcn_id_oe_syscall_epoll_wake_ocall = 8,
    gwas_fcn_id_oe_syscall_epoll_ctl_ocall = 9,
    gwas_fcn_id_oe_syscall_epoll_close_ocall = 10,
    gwas_fcn_id_oe_syscall_open_ocall = 11,
    gwas_fcn_id_oe_syscall_read_ocall = 12,
    gwas_fcn_id_oe_syscall_write_ocall = 13,
    gwas_fcn_id_oe_syscall_readv_ocall = 14,
    gwas_fcn_id_oe_syscall_writev_ocall = 15,
    gwas_fcn_id_oe_syscall_lseek_ocall = 16,
    gwas_fcn_id_oe_syscall_pread_ocall = 17,
    gwas_fcn_id_oe_syscall_pwrite_ocall = 18,
    gwas_fcn_id_oe_syscall_close_ocall = 19,
    gwas_fcn_id_oe_syscall_flock_ocall = 20,
    gwas_fcn_id_oe_syscall_fsync_ocall = 21,
    gwas_fcn_id_oe_syscall_fdatasync_ocall = 22,
    gwas_fcn_id_oe_syscall_dup_ocall = 23,
    gwas_fcn_id_oe_syscall_opendir_ocall = 24,
    gwas_fcn_id_oe_syscall_readdir_ocall = 25,
    gwas_fcn_id_oe_syscall_rewinddir_ocall = 26,
    gwas_fcn_id_oe_syscall_closedir_ocall = 27,
    gwas_fcn_id_oe_syscall_stat_ocall = 28,
    gwas_fcn_id_oe_syscall_fstat_ocall = 29,
    gwas_fcn_id_oe_syscall_access_ocall = 30,
    gwas_fcn_id_oe_syscall_link_ocall = 31,
    gwas_fcn_id_oe_syscall_unlink_ocall = 32,
    gwas_fcn_id_oe_syscall_rename_ocall = 33,
    gwas_fcn_id_oe_syscall_truncate_ocall = 34,
    gwas_fcn_id_oe_syscall_ftruncate_ocall = 35,
    gwas_fcn_id_oe_syscall_mkdir_ocall = 36,
    gwas_fcn_id_oe_syscall_rmdir_ocall = 37,
    gwas_fcn_id_oe_syscall_fcntl_ocall = 38,
    gwas_fcn_id_oe_syscall_ioctl_ocall = 39,
    gwas_fcn_id_oe_syscall_poll_ocall = 40,
    gwas_fcn_id_oe_syscall_kill_ocall = 41,
    gwas_fcn_id_oe_syscall_close_socket_ocall = 42,
    gwas_fcn_id_oe_syscall_socket_ocall = 43,
    gwas_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 44,
    gwas_fcn_id_oe_syscall_socketpair_ocall = 45,
    gwas_fcn_id_oe_syscall_connect_ocall = 46,
    gwas_fcn_id_oe_syscall_accept_ocall = 47,
    gwas_fcn_id_oe_syscall_bind_ocall = 48,
    gwas_fcn_id_oe_syscall_listen_ocall = 49,
    gwas_fcn_id_oe_syscall_recvmsg_ocall = 50,
    gwas_fcn_id_oe_syscall_sendmsg_ocall = 51,
    gwas_fcn_id_oe_syscall_recv_ocall = 52,
    gwas_fcn_id_oe_syscall_recvfrom_ocall = 53,
    gwas_fcn_id_oe_syscall_send_ocall = 54,
    gwas_fcn_id_oe_syscall_sendto_ocall = 55,
    gwas_fcn_id_oe_syscall_recvv_ocall = 56,
    gwas_fcn_id_oe_syscall_sendv_ocall = 57,
    gwas_fcn_id_oe_syscall_shutdown_ocall = 58,
    gwas_fcn_id_oe_syscall_setsockopt_ocall = 59,
    gwas_fcn_id_oe_syscall_getsockopt_ocall = 60,
    gwas_fcn_id_oe_syscall_getsockname_ocall = 61,
    gwas_fcn_id_oe_syscall_getpeername_ocall = 62,
    gwas_fcn_id_oe_syscall_getaddrinfo_open_ocall = 63,
    gwas_fcn_id_oe_syscall_getaddrinfo_read_ocall = 64,
    gwas_fcn_id_oe_syscall_getaddrinfo_close_ocall = 65,
    gwas_fcn_id_oe_syscall_getnameinfo_ocall = 66,
    gwas_fcn_id_oe_syscall_nanosleep_ocall = 67,
    gwas_fcn_id_oe_syscall_clock_nanosleep_ocall = 68,
    gwas_fcn_id_oe_syscall_getpid_ocall = 69,
    gwas_fcn_id_oe_syscall_getppid_ocall = 70,
    gwas_fcn_id_oe_syscall_getpgrp_ocall = 71,
    gwas_fcn_id_oe_syscall_getuid_ocall = 72,
    gwas_fcn_id_oe_syscall_geteuid_ocall = 73,
    gwas_fcn_id_oe_syscall_getgid_ocall = 74,
    gwas_fcn_id_oe_syscall_getegid_ocall = 75,
    gwas_fcn_id_oe_syscall_getpgid_ocall = 76,
    gwas_fcn_id_oe_syscall_getgroups_ocall = 77,
    gwas_fcn_id_oe_syscall_uname_ocall = 78,
    gwas_fcn_id_oe_get_supported_attester_format_ids_ocall = 79,
    gwas_fcn_id_oe_get_qetarget_info_ocall = 80,
    gwas_fcn_id_oe_get_quote_ocall = 81,
    gwas_fcn_id_oe_get_quote_verification_collateral_ocall = 82,
    gwas_fcn_id_oe_verify_quote_ocall = 83,
    gwas_fcn_id_oe_sgx_get_cpuid_table_ocall = 84,
    gwas_fcn_id_oe_sgx_backtrace_symbols_ocall = 85,
    gwas_fcn_id_oe_sgx_thread_wake_wait_ocall = 86,
    gwas_fcn_id_oe_sgx_wake_switchless_worker_ocall = 87,
    gwas_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 88,
    gwas_fcn_id_untrusted_call_max = OE_ENUM_MAX
};

/**** OCALL marshalling structs. ****/
typedef struct _getclientlist_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    char* hostlist;
} getclientlist_args_t;

typedef struct _getcovlist_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _getbatch_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _writebatch_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
static void ocall_getclientlist(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    getclientlist_args_t* _pargs_in = (getclientlist_args_t*)input_buffer;
    getclientlist_args_t* _pargs_out = (getclientlist_args_t*)output_buffer;
    ...
    if (_pargs_in->hostlist)
        OE_SET_OUT_POINTER(hostlist, 1, sizeof(char[ENCLAVE_READ_BUFFER_SIZE]), char*);

    /* Call user function. */
    getclientlist(
        *(char(*)[ENCLAVE_READ_BUFFER_SIZE])_pargs_in->hostlist);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    getcovlist_args_t* _pargs_in = (getcovlist_args_t*)input_buffer;
    getcovlist_args_t* _pargs_out = (getcovlist_args_t*)output_buffer;
    ...
    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->covlist)
        OE_SET_OUT_POINTER(covlist, 1, sizeof(char[ENCLAVE_READ_BUFFER_SIZE]), char*);

    /* Call user function. */
    getcovlist(
        *(char(*)[ENCLAVE_READ_BUFFER_SIZE])_pargs_in->covlist);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    gety_args_t* _pargs_in = (gety_args_t*)input_buffer;
    gety_args_t* _pargs_out = (gety_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->host)
        OE_SET_IN_POINTER(host, 1, sizeof(const char[MAX_CLIENTNAME_LENGTH]), char*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->y)
        OE_SET_OUT_POINTER(y, 1, sizeof(char[ENCLAVE_READ_BUFFER_SIZE]), char*);

    /* Call user function. */
    gety(
        *(const char(*)[MAX_CLIENTNAME_LENGTH])_pargs_in->host,
        *(char(*)[ENCLAVE_READ_BUFFER_SIZE])_pargs_in->y);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    getcov_args_t* _pargs_in = (getcov_args_t*)input_buffer;
    getcov_args_t* _pargs_out = (getcov_args_t*)output_buffer;
    ...
    if (_pargs_in->host)
        OE_SET_IN_POINTER(host, 1, sizeof(const char[MAX_CLIENTNAME_LENGTH]), char*);
    if (_pargs_in->cov_name)
        OE_SET_IN_POINTER(cov_name, 1, sizeof(const char[MAX_CLIENTNAME_LENGTH]), char*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->cov)
        OE_SET_OUT_POINTER(cov, 1, sizeof(char[ENCLAVE_READ_BUFFER_SIZE]), char*);

    /* Call user function. */
    getcov(
        *(const char(*)[MAX_CLIENTNAME_LENGTH])_pargs_in->host,
        *(const char(*)[MAX_CLIENTNAME_LENGTH])_pargs_in->cov_name,
        *(char(*)[ENCLAVE_READ_BUFFER_SIZE])_pargs_in->cov);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    getbatch_args_t* _pargs_in = (getbatch_args_t*)input_buffer;
    getbatch_args_t* _pargs_out = (getbatch_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->hostname)
        OE_SET_IN_POINTER(hostname, 1, sizeof(const char[MAX_CLIENTNAME_LENGTH]), char*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->batch)
        OE_SET_OUT_POINTER(batch, 1, sizeof(char[ENCLAVE_READ_BUFFER_SIZE]), char*);

    /* Call user function. */
    _pargs_out->oe_retval = getbatch(
        *(const char(*)[MAX_CLIENTNAME_LENGTH])_pargs_in->hostname,
        _pargs_in->type,
        *(char(*)[ENCLAVE_READ_BUFFER_SIZE])_pargs_in->batch);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    writebatch_args_t* _pargs_in = (writebatch_args_t*)input_buffer;
    writebatch_args_t* _pargs_out = (writebatch_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->buffer)
        OE_SET_IN_POINTER(buffer, 1, sizeof(char[ENCLAVE_OUTPUT_BUFFER_SIZE]), char*);
    ...
    writebatch(
        _pargs_in->type,
        *(char(*)[ENCLAVE_OUTPUT_BUFFER_SIZE])_pargs_in->buffer);
    ...
    size_t* output_bytes_written)
{
    ...
    if (_pargs_in->format_ids)
        OE_SET_OUT_POINTER(format_ids, 1, _pargs_in->format_ids_size, void*);
    if (_pargs_in->format_ids_size_out)
        OE_SET_OUT_POINTER(format_ids_size_out, 1, sizeof(size_t), size_t*);

    /* Call user function. */
    _pargs_out->oe_retval = oe_get_supported_attester_format_ids_ocall(
        _pargs_in->format_ids,
        _pargs_in->format_ids_size,
        _pargs_in->format_ids_size_out);
...
static oe_ocall_func_t _gwas_ocall_function_table[] = {
    (oe_ocall_func_t) ocall_getclientlist,
    (oe_ocall_func_t) ocall_getcovlist,
    (oe_ocall_func_t) ocall_gety,
    (oe_ocall_func_t) ocall_getcov,
    (oe_ocall_func_t) ocall_getbatch,
    (oe_ocall_func_t) ocall_writebatch,
...
oe_result_t oe_create_gwas_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _gwas_ocall_function_table,
               89,
               _gwas_ecall_info_table,
                8,
               enclave);
}
